...
So, for example, to get the closest monthly puts with at least 2 days to maturity, use the tring 
...
3. There is no need to specify the `datatype` parameter as an argument to `av_get()`. The function will return a data.table
