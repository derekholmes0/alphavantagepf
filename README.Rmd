...
and several helper functions are included to extract data from more complex API calls.  A Shiny interface is also provided to download, visualize and manage data for sets of assets, including ETFs and FX.
...
knitr::include_graphics("img/av_shiny_1.png")
```
...
line, and click `save`.  To recall, select the name from the dropdown and click `get`. 
