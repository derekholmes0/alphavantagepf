...
For example, to show a normalized total return chart for 3 common ETS, select "start" to rebase at the start of the requested period (`"-2y::"`in `dts`) select `TS:PriceTS` to get a time series graph,
