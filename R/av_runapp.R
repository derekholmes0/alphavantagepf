...
#' tables, plots, or dygraphs below the command line, and possibly in an additional tab to the right of the main tab.  The secondary tab
#' will change names as approprriate, and the focus may be changed off the MAIN tab.
#'
...
#'
#' **Other niceties**:
#' * Groups of assets can be named, saved, and recalled easily.  The saved name can then be used in lieu of the original list. See [Basic Usage](https://derekholmes0.github.io/alphavantagepf/articles/ShinyApp_1_setup_and_usage.html) vignette
...
#' to set the directory, and the [Data](https://derekholmes0.github.io/alphavantagepf/articles/ShinyApp_3_Data_Management.html) vignette for details on how the data is structured.
...
#' * Data within each produced graph or table can be copied to the clipboard (option in  `AVOPTS` page), See [Setup](https://derekholmes0.github.io/alphavantagepf/articles/ShinyApp_1_setup_and_usage.html) vignette to see where to turn this on.
...
#' * User price data, earnings data, and asset groups can be added using helper functions  [av_add_px()], [av_add_earn()], [av_add_assetgroups()].  See [data](https://derekholmes0.github.io/alphavantagepf/articles/ShinyApp_3_Data_Management.html) vignette.
#' Adding data from the console immediately adds the data to the app.
