globalVariables(c('.','value','ltype','variable','av_fn','timestamp','expiration','type','delta','.SD','year','between','wday','isday','.I','rolldt',
                  ...
                  'adjusted_close','anopt1','anopt2','catg','catprio','change_percentage','cummktrtn','cumrtn','dtstr_hist','dtstr_window','dtstartfrac','EquityName','ETFName',
                  'events','istr1','istr2','list1','list2','listnm','umindelta','mktrtn','ncak','newssort','ochains','oscaling','otodisplay',
                  ...
                  'hibpopen','lowbpopen','prevclose','reportedDate','name','classtype','daysExp'
                  ))
