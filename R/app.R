            ...
            tabsetPanel(id="inTabset",selected=the_av$starttab,
              ...
              tabPanel("AVOPTS",value="avopts",
                  column(width=2,
                    ...
                    span(textInput(inputId="requestpace", label="av request pacet", value=the_av$max_requests_per_min),style=avsd$labelcss),
...
av_make_server <- function() {
  ...
  av_server<-function(input, output,session) {
    ...
    avpf_set_request_pace(input$requestpace)
