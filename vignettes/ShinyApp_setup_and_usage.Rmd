---
title: "ShinyApp_setup_and_usage"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ShinyApp_setup_and_usage}
...
typically buried in long paths, you may find it helpful to set an alternative location, as shown below.
...
state variables is shown, with any changes highlighted.
...
||Cached time series are in the file `av(in [fst](https://www.fstpackage.org/) format), and|
