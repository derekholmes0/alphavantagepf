...
your entitlement status (Either `delayed` or `realtime`), and hit the blue <span style="background-color: #337AB7; color: #FFFFFF;">Set Opts</span> button.
...
type in the components (separated by semi-colons) and hit the <span style="background-color: #337AB7; color: #FFFFFF;">set</span> button.

* **To get the assets in a list**, select the desired list from the dropdown and hit <span style="background-color: #337AB7; color: #FFFFFF;">get</span> button.
...
<span style="background-color: #337AB7; color: #FFFFFF;">RUN</span> button.  One of more graphs or tables
...
The table below shows the current analyses that can be run.  Select what you wish and hit the <span style="background-color: #337AB7; color: #FFFFFF;">RUN</span> button.
