...
Once it is running, we then give a brief overview of list management and individual analysis components.  Augmenting the data is also described. 
...
This file will be a named list of  [data.tables](https://github.com/Rdatatable/data.table), with a data.table containing all downloaded data corresponding to 
