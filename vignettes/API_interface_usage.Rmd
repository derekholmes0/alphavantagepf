...
2. `av_get_pf()` has an optional `delay` parameter, which may be needed if several short API calls are called sequentially  (e.g. within another function).
