---
title: "ShinyApp_4_New_Functionality"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ShinyApp_4_New_Functionality}
...
The app is designed to be extended by allowing users to add new functions outside the**Alphavantagepf** package.  
...
or by inspecting the source code of the `ui` function generator in the file `app.R`.
...
|:--------:|:-----------------------|
|[narrowbydtstr()](https://derekholmes0.github.io/FinanceGraphs/reference/fg_date_utilities.html)|Filter a `data.table()` using a date string|
...
These functions facilitate transformation of succinct date strings such as `"-3y::"` to actual dates, possibly with offsets, e.g.
...
* The function is a `data.table()`-centric, but does not need to be.  [Yidyverse](https://tidyverse.org/) idioms can be used, but are likely to be
slower.
